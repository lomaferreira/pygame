...
x_azul=randint(40,600) #posições de escolha pra x, desconsiderando a altura do retangulo pra n sair da tela
...
while True:
    ...
    texto_formatado=fonte.render(mensagem,True,(255,255,255)) #uni a msg e a fonte(mensagem, false=maisPixelado)
    ...
    tela.blit(texto_formatado,(450,440))#rederiza a msg na tela na seguinte posição
